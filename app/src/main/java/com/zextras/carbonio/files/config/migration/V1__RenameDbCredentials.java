 ...
 * carbonio-files/db-*}) to the carbonio-quarkus-extensions-database slash-separated KV path
 * ({@code carbonio-files/database/credentials/db-*}) that the database extension reads.
 *
