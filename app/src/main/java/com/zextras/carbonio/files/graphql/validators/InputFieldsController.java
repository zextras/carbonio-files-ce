 ...
 * output. These methods are used during the creation of the {@link GraphQL} instance (see the
 * GraphQL provider's <code>buildValidationInstrumentation()</code> method).
 */
@ApplicationScoped
public class InputFieldsController {
  ...
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
    ...
    return (fieldAndArguments, environment) -> {
      return new GenericControllerEvaluator(fieldAndArguments, environment)
