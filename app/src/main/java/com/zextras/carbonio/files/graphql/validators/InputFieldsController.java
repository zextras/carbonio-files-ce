 ...
 * GraphQL provider's <code>buildValidationInstrumentation()</code> method).</p>
 */
@ApplicationScoped
public class InputFieldsController {
  ...
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>> shareQueriesValidation() {
    return (fieldAndArguments, environment) ->
    {
      GenericControllerEvaluator controller = new GenericControllerEvaluator(fieldAndArguments, environment)
