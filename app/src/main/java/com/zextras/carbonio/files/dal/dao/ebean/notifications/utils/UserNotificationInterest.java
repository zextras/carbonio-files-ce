...
public class UserNotificationInterest {
  ...
  protected UserNotificationInterest() {}
  ...
  @JoinColumn(
      name = Constants.Db.UserNotificationInterest.USER_ID,
      insertable = false,
      updatable = false)
  private UserNotificationsInfo userInfo;

  @Column(
      name = Constants.Db.UserNotificationInterest.NOTIFICATION_ID,
      length = 36,
      nullable = false)
  ...
  public UserNotificationInterest(
      String interestId, String userId, String notificationId, Long createdAt) {
