...
/**
 * Config-split sibling of {@link AddedNodeNotificationCopyApiIT} (Batch I / D3): carries the ONE
...
class AddedNodeNotificationCopyDisabledIT extends AbstractFilesIT {
  ...
  @Test
  void givenANodeCopyOnASharedDirectoryAndDisabledNotificationsNoNotificationShouldBeSavedOrReturned() {
    // Given
    ...
    String copyMutation =
        GraphqlCommandBuilder.aMutationBuilder("copyNodes")
            ...
            .build();
    graphql(copyMutation, OWNER_COOKIE);
