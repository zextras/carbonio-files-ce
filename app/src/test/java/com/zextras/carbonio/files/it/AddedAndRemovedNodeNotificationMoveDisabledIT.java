...
/**
 * Config-split sibling of {@link AddedAndRemovedNodeNotificationMoveApiIT} (Batch I / D3): carries
 * the ONE scenario that needs notifications disabled ({@link NotificationsDisabledResource},
 * class-restricted).
 */
@WithTestResource(
    value = NotificationsDisabledResource.class,
    scope = TestResourceScope.RESTRICTED_TO_CLASS)
class AddedAndRemovedNodeNotificationMoveDisabledIT extends AbstractFilesIT {
