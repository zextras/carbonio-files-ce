 ...
 * moved to the sibling {@link InternalBlobResourceSizeCapIT} (upload cap set to 0 at runtime, so
 * ANY non-empty body proves the bypass). This class keeps the remaining 8 methods on the shared
 * default (uncapped) stack. Mapping: 8 (here) + 1 ({@code InternalBlobResourceSizeCapIT}) = 9
