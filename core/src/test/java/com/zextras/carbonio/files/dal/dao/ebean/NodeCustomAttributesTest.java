...
class NodeCustomAttributesTest {
  ...
  void givenAllNodeCustomAttributesTheConstructorShouldCreateNodeCustomAttributeObjectCorrectly() {
    ...
    NodeCustomAttributes nodeCustomAttributes =
        new NodeCustomAttributes(
            "56a6a78c-d8b5-447b-847a-e2c3a1c69f35", "90d9fb09-bbe6-4441-b09e-f8e17db7baef", true);

    Assertions.assertThat(nodeCustomAttributes.getNodeId())
        .isEqualTo("56a6a78c-d8b5-447b-847a-e2c3a1c69f35");
    Assertions.assertThat(nodeCustomAttributes.getUserId())
  ...
  void givenNodeIdAndVersionTheFileVersionPKConstructorShouldCreateFileVersionPKObjectCorrectly() {
    // Given & When
    NodeCustomAttributesPK nodeCustomAttributesPrimaryKey =
        new NodeCustomAttributesPK(
            "868b43cc-3a8f-4c14-a66d-f520d8e7e8bd", "90d9fb09-bbe6-4441-b09e-f8e17db7baef");

    // Then
    Assertions.assertThat(nodeCustomAttributesPrimaryKey.getNodeId())
        .isEqualTo("868b43cc-3a8f-4c14-a66d-f520d8e7e8bd");
    Assertions.assertThat(nodeCustomAttributesPrimaryKey.getUserId())
        .isEqualTo("90d9fb09-bbe6-4441-b09e-f8e17db7baef");
  }
}
