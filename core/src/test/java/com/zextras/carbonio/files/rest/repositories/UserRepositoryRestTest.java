...
class UserRepositoryRestTest {
    ...
    void setup() {
        ...
        userRepositoryRest = new UserRepositoryRest(cacheHandlerMock, userManagementClientMock);
    }
    ...
    void givenUserManagementsUsermyselfGetUserMyselfByCookieNotCachedShouldContainUserMyself() {
        ...
        UserMyself userMyself = new UserMyself(userId, "", "", "", UserStatus.ACTIVE, Locale.ENGLISH, UserType.INTERNAL, Map.of("carbonioFeatureFilesEnabled", "TRUE"));
