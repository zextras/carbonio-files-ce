...
class LinkTest {
  ...
  void givenAllPublicLinkAttributesTheConstructorShouldCreateLinkObjectCorrectly() {
    ...
    Assertions.assertThat(publicLink.getNodeId()).isEqualTo("ac3da3d3-b1c0-41f1-b0ab-2b6d7328808c");
    Assertions.assertThat(publicLink.getPublicId()).isEqualTo("abcd1234");
    Assertions.assertThat(publicLink.getCreatedAt()).isEqualTo(5L);
    Assertions.assertThat(publicLink.getExpiresAt()).isPresent().get().isEqualTo(10L);
    Assertions.assertThat(publicLink.getDescription())
        .isPresent()
        .get()
