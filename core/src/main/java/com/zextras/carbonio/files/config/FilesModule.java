...
import com.zextras.carbonio.files.dal.repositories.impl.ebean.InvitationLinkRepositoryEbean;
...
public class FilesModule extends AbstractModule {
  ...
  public void configure() {
    ...
    bind(InvitationLinkRepository.class).to(InvitationLinkRepositoryEbean.class);
