...
/**
 * Classes extending this interface are basically a repository for MessageBroker (RabbitMQ). They
 * have the responsibility of starting consumers of events that need to be listened to.
 *
 ...
 *
 * <p>The {@link #publishEvent(BaseEvent)} method should use Message Broker Client from relative SDK
 * to publish an event.
 *
 * <p>The {@link #getMessageBrokerClient()} method should return Message Broker Client from Message
 * Broker SDK.
 */
