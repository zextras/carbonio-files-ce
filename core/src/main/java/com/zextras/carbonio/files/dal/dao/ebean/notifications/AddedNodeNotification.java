...
public class AddedNodeNotification extends BaseNotification {
  ...
  @Column(
      name = Constants.Db.AddedNodeNotification.ADDED_NODE_SNAPSHOT_ID,
      length = 36,
      nullable = false)
  ...
  @Column(
      name = Constants.Db.AddedNodeNotification.DESTINATION_FOLDER_SNAPSHOT_ID,
      length = 36,
      nullable = false)
  ...
  public AddedNodeNotification(
      String notificationId,
      Long createdAt,
      String addedNodeSnapshotId,
      String destinationFolderSnapshotId,
