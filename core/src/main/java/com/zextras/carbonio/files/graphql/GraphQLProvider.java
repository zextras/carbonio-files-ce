...
public class GraphQLProvider {
    ...
    return RuntimeWiring.newRuntimeWiring()
        ...
        .type(
            newTypeWiring("Query")
                ...
                .dataFetcher(
                    Constants.GraphQL.Queries.GET_ROOTS_LIST, nodeDataFetcher.getRootsListFetcher())
                ...
                .dataFetcher(
                    Constants.GraphQL.Queries.GET_VERSIONS, nodeDataFetcher.getVersionsFetcher())
                .dataFetcher(
        ...
        .type(
            newTypeWiring("Mutation")
                ...
                .dataFetcher(
                    Constants.GraphQL.Mutations.UPDATE_NODE, nodeDataFetcher.updateNodeFetcher())
                ...
                .dataFetcher(
                    Constants.GraphQL.Mutations.DELETE_NODES, nodeDataFetcher.deleteNodesFetcher())
                .dataFetcher(
                    Constants.GraphQL.Mutations.DELETE_ALL_NODES_AND_BLOBS,
                    nodeDataFetcher.deleteAllNodesAndBlobs())
                .dataFetcher(
                ...
                .dataFetcher(
                    Constants.GraphQL.Mutations.CREATE_SHARE, shareDataFetcher.createShareFetcher())
                .dataFetcher(
        ...
        .type(
            newTypeWiring(Constants.GraphQL.Types.FOLDER)
                ...
                .dataFetcher(
                    Constants.GraphQL.Folder.CHILDREN, nodeDataFetcher.getChildNodesFetcherFast())
                .dataFetcher(
        ...
        .type(
            newTypeWiring(Constants.GraphQL.Types.SHARE)
                ...
                .dataFetcher(
                    Constants.GraphQL.Share.SHARE_TARGET, userDataFetcher.shareTargetUserFetcher()))
        .type(
            newTypeWiring(Constants.GraphQL.Types.DISTRIBUTION_LIST)
                .dataFetcher(
                    Constants.GraphQL.DistributionList.USERS, userDataFetcher.getDLUsersFetcher()))
        .type(
        ...
        // Since we always return the nested objects with the notification call, no need to fetch
        // them again (return as is)
        .type(
  ...
  private GraphQLSchema buildSchema(RuntimeWiring wiring) {
    ...
    GraphQLSchema graphQLSchema =
        new SchemaGenerator().makeExecutableSchema(new SchemaParser().parse(schema), wiring);
