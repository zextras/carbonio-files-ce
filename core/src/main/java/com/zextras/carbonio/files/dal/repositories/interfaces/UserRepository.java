...
public interface UserRepository {
  ...
  /**
   * Retrieves a {@link UserMyself} without caching the response and/or checking if it already
   * retrieved since it is not requested often and we always want the updated version.
   *
