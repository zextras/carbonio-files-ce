 ...
 *
 * <p>In order to use this interface is useful to create a private object that contains:
 *
 * <ul>
 *   <li>the element that must be memorized
 *   <li>the time in milliseconds when the element is memorized so the cache can verify if the
...
public interface Cache<T> {
   ...
   *
   * <p>The default lifetime must be in milliseconds and must be specified during the creation of
   * the cache.
   *
   ...
   *
   * <ul>
   *   <li>It exists in the cache
   *   <li>It is not expired
   *   <li>Its key is contained in the {@link Collection<String>} specified in input
   * </ul>
   *
