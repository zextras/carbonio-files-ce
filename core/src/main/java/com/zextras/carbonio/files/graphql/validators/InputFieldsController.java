...
/**
 * This class contains the implementations of all input validation rules necessary to check if
 ...
 * GraphQLProvider} <code>buildValidationInstrumentation()</code> method).
 */
public class InputFieldsController {
  ...
  @Inject
  public InputFieldsController(
      GenericControllerEvaluatorFactory genericControllerEvaluatorFactory) {
  ...
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
    ...
    return (fieldAndArguments, environment) -> {
      return mGenericControllerEvaluatorFactory
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#CREATE_FOLDER} to check if the parent id is valid and if the
   *     folder name in input is valid.
   * @see GenericControllerEvaluator#checkNodeId(String)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#UPDATE_NODE} to check if the id, the name and/or the
   *     description of the node are valid.
   * @see GenericControllerEvaluator#checkNodeId(String)
   * @see GenericControllerEvaluator#checkNodeName(String)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link Constants.GraphQL.Mutations#MOVE_NODES}
   *     to check if the ids of the nodes to move and the destination are valid.
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#DELETE_NODES} to check if the ids of the nodes to delete are
   *     valid.
   * @see GenericControllerEvaluator#checkNodesIds(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      deleteNodesValidation() {
    return ((fieldAndArguments, environment) ->
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#TRASH_NODES} to check if the ids of the nodes to trash are
   *     valid.
   * @see GenericControllerEvaluator#checkNodesIds(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      trashNodesValidation() {
    return ((fieldAndArguments, environment) ->
        mGenericControllerEvaluatorFactory
            .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#RESTORE_NODES} to check if the ids of the nodes to delete are
   *     valid.
   * @see GenericControllerEvaluator#checkNodesIds(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      restoreNodesValidation() {
    return ((fieldAndArguments, environment) ->
        mGenericControllerEvaluatorFactory
            .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link Constants.GraphQL.Mutations#COPY_NODES}
   *     to check if the ids of the nodes to move and the destination are valid.
   * @see GenericControllerEvaluator#checkNodesIds(String)
   * @see GenericControllerEvaluator#checkNodeId(String)
   */
   ...
   *     Constants.GraphQL.Types#SHARE} type check if the node id and the target user id in input
   *     are valid.
   * @see GenericControllerEvaluator#checkNodeId(String)
   * @see GenericControllerEvaluator#checkUserId(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      shareQueriesValidation() {
    return (fieldAndArguments, environment) -> {
      GenericControllerEvaluator controller =
          mGenericControllerEvaluatorFactory
              .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#UPDATE_SHARES} and {@link
   *     Constants.GraphQL.Mutations#DELETE_SHARES} mutations to check if the node id and the target
   *     user ids in input are valid.
   * @see GenericControllerEvaluator#checkNodeId(String)
   * @see GenericControllerEvaluator#checkUserIds(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      bulkShareQueriesValidation() {
    return (fieldAndArguments, environment) -> {
      GenericControllerEvaluator controller =
          mGenericControllerEvaluatorFactory
              .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#CREATE_LINK} to check if the node id and/or the link
   *     description and/or the access code are valid.
   * @see GenericControllerEvaluator#checkNodeId(String)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#UPDATE_LINK} to check if the link id and/or the link
   *     description and/or the access code are valid.
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#DELETE_LINKS} to check if the link ids to remove are valid.
   * @see GenericControllerEvaluator#checkLinkIds(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      deleteLinksValidation() {
    return (fieldAndArguments, environment) -> {
      return mGenericControllerEvaluatorFactory
          .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Queries#GET_ACCOUNT_BY_EMAIL} to check if the email in input is valid.
   * @see GenericControllerEvaluator#checkEmail(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      getAccountByEmailValidation() {
    return (fieldAndArguments, environment) -> {
      return mGenericControllerEvaluatorFactory
          .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Queries#GET_ACCOUNTS_BY_EMAIL} to check if the list of emails in input
   *     are valid.
   * @see GenericControllerEvaluator#checkEmails(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      getAccountsByEmailValidation() {
    return (fieldAndArguments, environment) ->
        mGenericControllerEvaluatorFactory
            .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#CREATE_COLLABORATION_LINK} to check if the node id is valid.
   * @see GenericControllerEvaluator#checkNodeId(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      createCollaborationLinkValidation() {
    return (fieldAndArguments, environment) ->
        mGenericControllerEvaluatorFactory
            .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Queries#GET_COLLABORATION_LINKS} to check if the node id of the
   *     collaboration links to retrieve is valid.
   * @see GenericControllerEvaluator#checkNodeId(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      getCollaborationLinksValidation() {
    return (fieldAndArguments, environment) ->
        mGenericControllerEvaluatorFactory
            .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#DELETE_COLLABORATION_LINKS} to check if the collaboration link
   *     ids to remove are valid.
   * @see GenericControllerEvaluator#checkLinkIds(String)
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      deleteCollaborationLinksValidation() {
    return (fieldAndArguments, environment) ->
        mGenericControllerEvaluatorFactory
            .create(fieldAndArguments, environment)
  ...
  /**
   * @return a {@link BiFunction} rule bound with the {@link
   *     Constants.GraphQL.Mutations#DELETE_ALL_NODES_AND_BLOBS} to check if the user id is not
   *     empty or null.
   */
  public BiFunction<FieldAndArguments, FieldValidationEnvironment, Optional<GraphQLError>>
      deleteAllNodesAndBlobsValidation() {
    return (fieldAndArguments, environment) ->
        mGenericControllerEvaluatorFactory
            .create(fieldAndArguments, environment)
