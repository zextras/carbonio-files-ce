...
/**
 * This is the only class allowed to execute CRUD operations on a {@link FileVersion} element.
 *
...
public interface FileVersionRepository {
   ...
   */
  Optional<FileVersion> getFileVersion(String nodeId, int version);
   ...
   *
   * <ul>
   *   <li>it creates a new {@link FileVersion} and saves it in the database
   *   <li>it returns a {@link FileVersion} of the {@link FileVersion} just created
   * </ul>
   *
   * This method considers the parameters in input already valid so it does not do any kind of
   * control on them.
   *
  ...
  /**
   * Returns the {@link List} of all {@link FileVersion}s associated to a specific {@link Node}.
   *
  ...
  List<FileVersion> getFileVersions(String nodeId, Collection<Integer> versions);

  /**
   * Returns the most recent {@link FileVersion} associated with the specified {@link Node}.
   *
  ...
  /**
   * Updates a {@link FileVersion} on database.
   *
  ...
  void deleteFileVersions(String nodeId, Collection<Integer> versions);
   ...
   * @return a {@link Map} where the key is the node identifier and the value contains a {@link
   *     List} of {@link FileVersion}s linked to that node ordered by version ascending.
   */
